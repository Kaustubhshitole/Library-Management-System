...
from books as b
join issued_status as i on b.isbn=i.issued_book_isbn  group by b.book_title,i.issued_book_isbn);
...
#Writ a query to identify members who have overdue books (assume a 30-day return period).Display  the member 's_id, member's name, book title,
#issue date , and days overdue.alter
...
i.issued_date,
# r. return_date,
datediff(curdate(),issued_date)as
Days_overdue
...
join books as b on i.issued_book_isbn=b.isbn group by 1,2;
